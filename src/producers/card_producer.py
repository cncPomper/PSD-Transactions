...
if __name__ == "__main__":
    ...
    # Limit na karcie ustawiony na 1000zl
    ...
    cards = [Card(id, random.choice([user for user in users]), 100, 1500) for id in range(1, 1001)]
            ...
            if not anomaly:
                ...
                if anomaly == Anomalies.FREQ_ANOMALY:
                    ...
                    for i in range(2):
                        ...
                        producer.send(topic_name, data)
                        data["card_limit"] = data["card_limit"] * 2
                        data["amount"] = data["card_limit"] * 0.95
